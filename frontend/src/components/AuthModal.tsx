...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (mode === 'signup') {
        // 2. Registration with Rate Limiting
        ...
        // If backend returned regular error, check if email exists or fallback
        ...
        // Direct Supabase fallback if backend signup errored
        ...
        // 3. Login with Strict Per-IP & Per-Account Limits + Exponential Backoff
        ...
        // Fallback directly to Supabase client if backend is unreachable
